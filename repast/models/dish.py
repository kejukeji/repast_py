...
class Dish(Base, InitUpdate):
    ...
    dish_sort_id = Column(String(100), nullable=False)
    ...
    def __init__(self, **kwargs):
        args = ('group_id', 'group', 'brand_id','brand', 'dish_sort_id', 'dish_sort', 'name', 'picture_name')
        self.init_value(args, kwargs)

    def update(self, **kwargs):
        args = ('group_id', 'group', 'brand_id','brand', 'dish_sort_id', 'dish_sort', 'name')
        self.update_value(args, kwargs)